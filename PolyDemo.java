...
/**
 * This is a driver for Circle, Shape, SimplePokeBall
 * Spray and Triangle classes.
 */
	...
	public class PolyDemoPanel extends JPanel {		
		...
		public Shape getRandShape() {
			...
			switch( ( int )(Math.random() * 6) ) {
				case 0: 	retVal = new Spray(x,y, 0xFF00000);//new Square( x, y, getRandInt(), getRandInt() );
							break;
				case 1: 	retVal = new Circle(x,y, 0xFF0000,(int)(Math.random()*90+10));//Cube( x, y, getRandInt(), getRandInt(), getRandInt() );
							break;
				case 2: 	retVal = new SimplePokeBall(x,y, (int)(Math.random()*90+10));
							break;
				case 3: 	retVal = new Tree(x,y, 0x00FFFF,(int)(Math.random()*90+10));//new Circle( x,y,getRandInt() );////new Cylinder( x,y, getRandInt(), getRandInt() );
							break;
				case 4: 	retVal = new Square(x,y, 0xFF00000);
							break;
				case 5:		retVal = new Triangle(x,y, 0x00000FF,(int)(Math.random()*90+10));
			}
...
/*
 *-Draw method, toString, and equals are polymorphic.
 *- You will need to determine which object you are using in order to call getRandShape?
 *- Shape a = new Square();
 * a.getRandShape;
 */
